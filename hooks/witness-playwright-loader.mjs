 ...
 * import the Witness fixture, this hook goes into every Playwright process
 * through NODE_OPTIONS and answers the spec's ordinary import of the
 * component package with the Witness fixture file instead. The fixture
 ...
 *   WITNESS_FIXTURE     absolute path of the fixture file
 *   WITNESS_CT_PACKAGE  the component package the project uses
 */
import { registerHooks } from 'node:module';
import { pathToFileURL } from 'node:url';
import * as path from 'node:path';

const fixturePath = process.env.WITNESS_FIXTURE;
const ctPackage = process.env.WITNESS_CT_PACKAGE;
